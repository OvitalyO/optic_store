package com.example.optic_store.config;

import com.example.optic_store.services.PersonDetailsService;
...
//    }
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .antMatchers("/optic","/css/*","/","/authentication/login", "/authentication/registration", "/error", "/product", "/img/**", "/product/info/{id}","/product/search").permitAll()
